...
insert into emp03 values (1111, 'SON', 'MANAGER',20);
...
desc emp01;
insert into emp01 values (1111, 'KING', 'MANAGER', 500, 'F', 70);


-- default : 컬럼에 입력값이 없을때 기본값을 설정해서 데이터 입력
select sysdate from emp01;
drop table emp01;
create table emp01(
    empno number(4) constraint PK_EMP01_EMPNO primary key,
    ename varchar2(10) constraint NN_EMP01_ENAME not null,
...
desc emp01;
insert into emp01 values (1111, 'KING', 'MANAGER1', 1500, 'F', 40, sysdate);
